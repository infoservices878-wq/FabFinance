    ...
    content: [
      {
        type: "paragraphs",
        items: [
          "Fab Finance met en œuvre des mesures techniques et organisationnelles appropriées pour protéger vos données contre toute perte, destruction, altération, accès ou divulgation non autorisés.",
        ],
      },
      {
        type: "table",
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm text-green-800 leading-relaxed">
                Fab Finance est conforme au Règlement Général sur la Protection des Données (RGPD – UE 2016/679).
